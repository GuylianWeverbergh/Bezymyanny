...
namespace Generic.Host.WPF.App
{
    ...
    public partial class App : Application
    {
        ...
        private BezymyannyDb _repository;
        ...
        public App()
        {
            var hostBuilder = new HostBuilder()
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    // Db registry:
                    var cs = context.Configuration.GetConnectionString("BezymyannyConnectionString");
                    _repository = new BezymyannyDb(cs); // new MemoryTennisRepository(); 
                    services.AddSingleton<BezymyannyDb>(_repository);
                });
        ...
        private async void OnStartup(object sender, StartupEventArgs e)
        {
            ...
            //_repository.ConnectionString = configuration.GetConnectionString("BezymyannyConnectionString");
